...
class TestVectorSpace(unittest.TestCase):
    ...
    def test_addition(self):
        ...
        v1 = FiniteDimensionalVectorSpaceElement(
            [RationalFieldElement(1, 2), RationalFieldElement(1, 3)], self.field
        )
        v2 = FiniteDimensionalVectorSpaceElement(
            [RationalFieldElement(1, 4), RationalFieldElement(1, 5)], self.field
        )
...
class TestLinearTransformation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.transformation = LinearTransformation(
    ...
    def test_application(self):
        """测试线性变换的应用"""
        v = FiniteDimensionalVectorSpaceElement(
            [RationalFieldElement(1, 1), RationalFieldElement(1, 1)], self.field
        )

import numpy as np
from scipy.linalg import lu, schur, hessenberg, polar, diagsvd
...
class MatrixDecompositions:
    ...
    @staticmethod
    def svd(matrix: np.ndarray, full_matrices: bool = True) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
        """奇异值分解
    ...
    @staticmethod
    def qr_decomposition(matrix: np.ndarray, mode: str = 'reduced') -> Tuple[np.ndarray, np.ndarray]:
        """QR分解
    ...
    @staticmethod
    def polar_decomposition(matrix: np.ndarray, side: str = 'right') -> Tuple[np.ndarray, np.ndarray]:
        """极分解
    ...
    @staticmethod
    def bidiagonal_decomposition(matrix: np.ndarray) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
        """双对角分解

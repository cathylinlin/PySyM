...
from PySyM.abstract_phys.symmetry_environments.base import (
...
class RotationOperation(SymmetryOperation):
    ...
    @property
    def group(self):
        from PySyM.core.group_theory.continuous_groups import RotationGroup
...
class TimeTranslationOperation(SymmetryOperation):
    ...
    @property
    def group(self):
        from PySyM.core.group_theory.continuous_groups import TimeTranslationGroup
...
class TimeReversalOperation(SymmetryOperation):
    ...
    @property
    def group(self):
        from PySyM.core.group_theory.discrete_groups import TimeReversalGroup
...
class TranslationSymmetry(PhysicalSymmetry):
    ...
    def generators(self) -> List[Any]:
        """平移生成元：动量算符"""
        from PySyM.abstract_phys.symmetry_operations.generators import MomentumGenerator
...
class RotationSymmetry(PhysicalSymmetry):
    ...
    def generators(self) -> List[Any]:
        """旋转生成元：角动量算符"""
        from PySyM.abstract_phys.symmetry_operations.generators import AngularMomentumGenerator
        n = self._dimension
...
class TimeTranslationSymmetry(PhysicalSymmetry):
    ...
    def generators(self) -> List[Any]:
        """时间平移生成元：哈密顿量"""
        from PySyM.abstract_phys.symmetry_operations.generators import HamiltonianGenerator
...
class ParitySymmetry(PhysicalSymmetry):
    ...
    def generators(self) -> List[Any]:
        """离散对称性，生成元为宇称算符"""
        from PySyM.abstract_phys.symmetry_operations.generators import ParityOperator
...
class TimeReversalSymmetry(PhysicalSymmetry):
    ...
    def generators(self) -> List[Any]:
        """时间反演算符"""
        from PySyM.abstract_phys.symmetry_operations.generators import TimeReversalOperator

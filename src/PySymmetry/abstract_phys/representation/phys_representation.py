...
if TYPE_CHECKING:
    from ...core.group_theory.abstract_group import Group, GroupElement
    from ...core.representation.abstract_representation import GroupRepresentation
...
class PhysicalRepresentation:
    ...
    def tensor_product(self, other: 'PhysicalRepresentation') -> 'PhysicalRepresentation':
        """张量积表示"""
...
class SU2Representation(IrreducibleRepresentation):
    ...
    def tensor_product_decomposition(self, other: 'SU2Representation') -> List['SU2Representation']:
    ...
    def wigner_3j_symbol(self, j2: float, m1: float, m2: float, 
                        j3: float, m1_prime: float, m2_prime: float) -> float:
    ...
    def wigner_6j_symbol(self, j1: float, j2: float, j3: float,
...
class LorentzRepresentation(PhysicalRepresentation):
    ...
    def tensor_product(self, other: 'LorentzRepresentation') -> List['LorentzRepresentation']:
        """张量积表示

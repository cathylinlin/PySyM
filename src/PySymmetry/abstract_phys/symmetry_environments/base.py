...
class SymmetryInfo:
    ...
    def __init__(
        ...
        breaking_pattern: str | None = None,
    ):
        self.group = group
...
class SymmetryParameters:
    ...
    def __init__(
        ...
        self.continuous_params = (
            continuous_params if continuous_params is not None else {}
        )
...
class PhysicalSymmetry(ABC):
    ...
    def __init__(
        self, symmetry_type: SymmetryType, group: Group, category: SymmetryCategory
    ):
